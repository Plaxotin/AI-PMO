...
- Use exactly three workflow roles for phased development: `Planner`, `Worker`, and `Tester`.
...
- The project-level custom `planner` subagent is defined in `.cursor/agents/planner.md`.
