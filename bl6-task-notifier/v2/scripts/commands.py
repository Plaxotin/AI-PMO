...
def help_text(role: str = "user") -> str:
    """Краткая справка — одинаково короткая для всех ролей (v2.2.2).

    Списки команд администратора по требованию владельца не показываем:
    админам достаточно свободной формы.
    """
    lines = [
        "Вот что я умею:",
        "",
